...
- [ ] Modify `pkg/tuigen/generator.go`
...
- [ ] Add analyzer tests in `pkg/tuigen/analyzer_test.go`
...
- [ ] Add generator tests in `pkg/tuigen/generator_test.go`
...
- [ ] Add render tests in `pkg/tui/element/render_test.go`
...
- [ ] Create integration test file (optional)
...
|-------|-------------|--------|
| 1 | Analyzer and generator changes + tests | Pending |
| 2 | Element struct, options, rendering + tests | Pending |
| 3 | LSP completions and integration | Pending |
