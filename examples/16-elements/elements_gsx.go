...
func (e *elementsApp) Render(app *tui.App) *tui.Element {
	...
	__tui_52.AddChild(__tui_62)
	__tui_0.AddChild(__tui_52)
	__tui_66 := tui.New(
		tui.WithText("+/-adjust progress|j/k scroll|q quit"),
		tui.WithTextStyle(tui.NewStyle().Dim()),
	)
	__tui_0.AddChild(__tui_66)
